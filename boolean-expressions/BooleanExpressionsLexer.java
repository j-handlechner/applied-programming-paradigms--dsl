...
public class BooleanExpressionsLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "IDENTIFIER", "BOOLEAN_CONST", 
			"LINEBREAK", "WS"
		};
	}
	...
	public BooleanExpressionsLexer(CharStream input) {
		super(input);
